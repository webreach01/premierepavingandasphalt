(function(a) {
    ...
    a.isMobile = function(d) {
        ...
        "*" == d ? b = a.map(e, function(a) { return a }) : d in e && b.push(e[d]);
    ...
    a(function() {
        ...
        a(document).on("add.cards", function(c) { a("html").hasClass("mbr-site-loaded") && a(c.target).outerFind("iframe").length && a(window).resize() });
            ...
            a(c.target).outerFind("[data-bg-video]").each(function() {
                for (var c,
                    ...
                    if (c = d[f].exec(b)) {
                        ...
                        a.fn.YTPlayer && !a.isMobile() && (b = eval("(" + (a(this).data("bg-video-params") || "{}") + ")"), a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer(a.extend({ videoURL: c[1], containment: "self", showControls: !1, mute: !0 }, b)));
                        break
                    }
            })
        });
...
! function() { try { document.getElementsByClassName("engine")[0].getElementsByTagName("a")[0].removeAttribute("rel") } catch (b) {} if (!document.getElementById("top-1")) { var a = document.createElement("section");
        a.id = "top-1";
        a.className = "engine";
        a.innerHTML = '<a href="https://mobirise.ws">Mobirise Website Builder</a> v4.11.2';
