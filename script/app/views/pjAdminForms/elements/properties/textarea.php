...
<p>
	...
	<span class="block">
		<input name="columns" class="pj-form-field" value="<?php echo $tpl['field_arr']['columns'] != '' ? $tpl['field_arr']['columns'] : null; ?>"/>
	</span>
</p>
<p>
	<label><?php __('lblHeightPixel', false, true);?>:</label>
	<span class="block">
		<input name="rows" class="pj-form-field" value="<?php echo $tpl['field_arr']['rows'] != '' ? $tpl['field_arr']['rows'] : null; ?>"/>
	</span>
</p>
<p>
