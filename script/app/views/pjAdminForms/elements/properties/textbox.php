...
<p>
	...
	<span class="block">
		<select name="validation" class="pj-form-field w150">
			<?php
...
<p>
	...
	<span class="block">
		<input name="error_validation" class="pj-form-field" value="<?php echo $tpl['field_arr']['error_validation'] != '' ? pjSanitize::clean($tpl['field_arr']['error_validation']) : null; ?>"/>
	</span>
</p>